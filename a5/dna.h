...
private:
	...
	*/
	...
	/*
	The ostream operator calls the toFasta() method with default arguments
	and passes the resulting stream to the ostream.
	*/
	friend std::ostream & operator<<(std::ostream & os, DNA p);
